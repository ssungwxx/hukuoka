      ...
      <section id="schedule" className="mb-12">
        ...
        <div className="space-y-6">
          ...
          <DaySchedule
            ...
            items={day3Items}
            note="💡 오전 맥주공장 견학 후 오후 쇼핑. 다음 날 클라이밍과 분리해 안전하게! 돈키호테 면세는 여권 필수 · ¥5,000 이상 구매 시"
          />
...
const day3Items: ScheduleItem[] = [
  ...
  },
  {
    ...
    emoji: "🍺",
    text: "키린 맥주 공장 견학 투어",
    detail: "朝倉市馬田3601 · 무료 · 약 80분 · 一番搾り 제조공정 견학 + 맥주 시음 2~3잔 포함 · 사전 예약 필수 (3/1부터 오픈) · 수요일 운영 여부 예약 시 확인",
    cost: "무료",
