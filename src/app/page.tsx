        ...
        budget={{
          ...
          items: [
            ...
            },
            {
              label: "식비 총합",
              amount: "~¥20,500",
              detail: "9끼 식사 (야타이~가라토시장 초밥까지)",
              icon: "🍽️",
            },
            {
              label: "액티비티",
              amount: "~¥3,000",
              detail: "클라이밍 + 맥주공장 (¥500)",
              icon: "🎯",
            },
          ],
        }}
...
const day2Items: ScheduleItem[] = [
  ...
  },
  {
    ...
    detail:
      "오호리 공원에서 도보 10분 · 벚나무 약 1,000그루 · 후쿠오카성 벚꽃축제(福岡城さくらまつり) 개최 기간 (야간 라이트업, 입장 ~¥300) · 무료 입장 (낮)",
  ...
  },
  {
    ...
    detail:
      "아크로스 후쿠오카 B2F · 10:30~21:00 · 무료 반찬바 (멘타이코·이쿠라·시오카라) 전설급 · 예약 불가 · 피크 이후 시간대라 대기 적음",
    cost: "¥800~1,200",
...
const day3Items: ScheduleItem[] = [
  ...
  },
  {
    ...
    text: "키린 맥주 공장 견학 투어",
    detail:
      "아사쿠라시 마다 3601 (朝倉市馬田) · ¥500 · 약 80분 · 이치반시보리(一番搾り) 제조공정 견학 + 맥주 시음 2~3잔 포함 · 사전 예약 필수 (3/1부터 오픈) · 수요일 운영 확인됨",
    cost: "¥500",
  ...
  },
  {
    ...
    detail:
      "투어 종료 후 여유 있게 출발 · 타치아라이→오고리(¥280) → 니시테츠→텐진(¥530) · 약 1시간~1시간 30분 소요",
    cost: "¥810",
  },
  {
    time: "13:30",
    ...
    text: "점심: 하카타 잇소 (博多一双)",
    detail:
      "하카타역 동쪽 도보 5분 · 11:00~24:00 · 아와케이(泡系) 톤코츠 라멘 · 크리미한 거품 육수가 특징 · 카에다마(替え玉, 면 추가) 필수 · 대기 30분+",
    cost: "¥800~1,100",
    location: { lat: 33.5901, lng: 130.425 },
    restaurant: {
      ...
      google: {
        rating: "Map",
        url: "https://www.google.com/maps/search/博多一双+博多駅東本店",
      },
    },
  },
  {
  ...
  },
  {
    ...
    detail:
      "야쿠인역(薬院) 도보 5~6분 · 야키토리 WEST 백명점 2024 선정 (焼き鳥 WEST 百名店) · 6일간 반복 굽기로 만드는 극강 바삭 닭껍질 · 돼지삼겹 꼬치(豚バラ)도 필수 · 예약 추천",
    cost: "¥2,500~4,000",
...
const day4Items: ScheduleItem[] = [
  ...
  },
  {
    ...
    text: "점심: 우동 타이라 (うどん平)",
    detail:
      "하카타구 스미요시 5-10-7 (博多区住吉) · 하카타역 도보 11분 · 월~금 11:30~16:00 · 일·공휴일 정기 휴무 · 부드러운 하카타식 면발 · 예약 불가, 점심 줄 있음",
    cost: "¥600~1,000",
  ...
  },
  {
    ...
    text: "베어핸즈 클라이밍으로 이동",
    detail:
      "하카타역 → 텐진미나미역(지하철) → 나나쿠마역 (나나쿠마선, 총 25분)",
    cost: "¥300",
  },
  {
    time: "13:30",
    ...
    detail:
      "조난구 나나쿠마 8-4-8 (城南区七隈) 나나쿠마 패밀리프라자 내 · 평일 13:00~23:00 · 금요 정기휴무(목요 OK!) · 초회 등록 약 10분 · 신발 렌탈 가능 · 맥주 없이 컨디션 최상!",
    cost: "~¥2,000~2,500",
  ...
  },
  {
    ...
    detail:
      "주오구 야쿠인 3-16-34 (中央区薬院) · 야쿠인오도리역 도보 4분 · 16:00~24:00(L.O.23:00) · A4·A5 큐슈산 흑모와규 시치린(七輪) 숯불구이 · 특선 7종 모듬(特選7種盛り) 필수 · 예약 추천",
    cost: "¥3,000~5,000",
...
const day5Items: ScheduleItem[] = [
  ...
  },
  {
    ...
    text: "모지코 바나나카레 브런치",
    detail:
      "모지코 명물 야키카레(門司港名物 焼きカレー) · 바나나맨, 미나토노카레야(港のカレー家) 등 · 대부분 11시 오픈이지만 BEAR FRUITS 등 일부 10:30~ · 가볍게 브런치로 즐기고 가라토 초밥에 대비!",
    cost: "~¥800~1,200",
    location: { lat: 33.9478, lng: 130.9625 },
  },
  {
    ...
    detail:
      "모지코에서 터널 입구까지 도보 약 15분 · 간몬터널 인도(関門トンネル人道) 전장 780m · 도보 약 15분 · 무료 · 규슈↔혼슈를 걸어서 건너는 체험!",
...
const mealData: MealEntry[] = [
  ...
  },
  {
    ...
    meal: "점심",
    theme: "라멘 (ラーメン)",
    restaurant: "하카타 잇소 (博多一双)",
  },
  {
    day: "Day 3",
    meal: "저녁",
    theme: "야키토리 (焼き鳥)",
    restaurant: "카와야 야쿠인본점 (かわ屋 薬院本店)",
  },
  {
    day: "Day 4",
    meal: "점심",
...
const checklistItems = [
  ...
  {
    label: "카와야 야쿠인 (かわ屋 薬院) 저녁 예약 (4/1)",
    category: "예약",
  },
