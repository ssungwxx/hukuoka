        ...
        budget={{
          ...
          items: [
            ...
            },
            {
              label: "교통비 총합",
              amount: "~¥8,500",
              detail: "공항↔中洲川端, 시내이동, 기타큐슈 왕복(JR 2025.4 운임개정 반영) 포함",
              icon: "🚇",
            },
            {
              label: "식비 총합",
...
const day3Items: ScheduleItem[] = [
  {
    ...
    detail:
      "中洲川端→텐진(지하철 1정거장 ¥210) → 니시테츠 텐진→오고리(급행 약 40분, ¥530) → 아마기철도 오고리→타치아라이(15분, ¥280) → 도보 15분 또는 무료 셔틀",
    cost: "편도 ¥1,020",
    location: { lat: 33.5897, lng: 130.4207 },
  },
  {
    ...
    text: "키린 맥주 공장 견학 투어",
    detail:
      "아사쿠라시 마다 3601 (朝倉市馬田) · ¥500 · 약 65~75분 · 이치반시보리(一番搾り) 제조공정 견학 + 맥주 시음 2~3잔 포함 · 사전 예약 필수 (3/1부터 오픈) · 정기휴관 월요일 · 수요일 운영 확인됨",
    cost: "¥500",
  ...
  },
  {
    ...
    detail:
      "투어 종료 후 여유 있게 출발 · 타치아라이→오고리(¥280) → 니시테츠 급행→텐진(¥530) · 약 1시간~1시간 30분 소요",
    cost: "¥810",
  },
  {
    time: "13:30",
  ...
  },
  {
    ...
    detail:
      "1934년 창업 후쿠오카 현존 최고(最古) 카페 · 고후쿠마치역(呉服町) 도보 2분 · 월~금 10:00~20:00 / 토 10:00~19:00 · 일·공휴일 휴무 · 쇼와 양관 건물의 정통 킷사텐 분위기 · 자체 로스팅 블렌드 커피",
    cost: "¥500~800",
